    ...
    <div class="position-relative">
      ...
      <section class="section-shaped my-0">
        ...
        <div class="container shape-container ">
          <div class="">
            <div class="row">
              <div class="col-lg-6"><h4 class="display-3 font-weight-bold text-white">
                Bem Vindo (a) Kenner</h4></div>
            
             
              <div class="col-lg-4 ml-lg-auto"><h4 class="display-3 font-weight-bold text-white">
                 Saldo: R$ 1.000</h4></div>
            </div>
          </div>
        </div>
      </section>
    ...
    <section class="section section-lg pt-lg-0 mt--200">
      <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="row row-grid">
              <div class="col-lg-4">
                <card class="border-0" hover shadow body-classes="py-5">
                  ...
                  <h6 class="text-primary text-uppercase">Efetue deposito rapido e facil

</h6>
            
                
                  <base-button tag="a" href="" type="primary" class="mt-4 col-lg-12" @click="testehttp">Depositar</base-button>
                </card>
              </div>
              ...
              <div class="col-lg-4">
                <card class="border-0" hover shadow body-classes="py-5">
                  ...
                  <base-button tag="a" href="#" type="success" class="mt-4 col-lg-12" @click="mostrar">Sacar</base-button>
                  <!-- </div> -->
                </card>
              </div>
              <div class="col-lg-4">
                <card class="border-0" hover shadow body-classes="py-5">
                  ...
                  <base-button tag="a" href="" type="warning" class="mt-4 col-lg-12">TRANSAÇÕES</base-button>
                </card>
              </div>
            </div>
         ...
         <div class="container" v-if="mostrarDadosConta">
        <div class="row position-relative" style="margin-top:5%;">
          <div class="col-lg-12">
            <card gradient="secondary" shadow body-classes="p-lg-5" >
              <h4 class="mb-1">Infome os dados da Conta</h4>
              <p class="mt-0">Dados da conta para deposito</p>
              <base-input
                class="mt-5"
                alternative
                placeholder="Your name"
                addon-left-icon="ni ni-user-run" v-model="requisicao.nome"
              ></base-input>
...
export default {
  ...
  methods: {
      ...
      testehttp() {
        this.$http.post('requisicao.php', this.requisicao).then(retorno => {
            console.log(retorno);
		}).catch(error => {
    ...
    mostrar() {
        if(this.mostrarDadosConta){
            this.mostrarDadosConta = false
        }else{
            this.mostrarDadosConta = true
        }
    },
  }
};
